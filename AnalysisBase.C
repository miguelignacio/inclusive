...
void AnalysisBase::InitMiniTree() {
   ...
   T->Branch("event_y_e", &fTreeVar.event_y_e, "event_y_e/F");
   T->Branch("event_Q2_e", &fTreeVar.event_Q2_e, "event_Q2_e/F");
   T->Branch("event_x_e", &fTreeVar.event_x_e, "event_x_e/F");
  
   T->Branch("event_y_s", &fTreeVar.event_y_s, "event_y_s/F");
   T->Branch("event_Q2_s", &fTreeVar.event_Q2_s, "event_Q2_s/F");
   T->Branch("event_x_s", &fTreeVar.event_x_s, "event_x_s/F");

   T->Branch("event_y_es", &fTreeVar.event_y_es, "event_y_es/F");
   T->Branch("event_Q2_es", &fTreeVar.event_Q2_es, "event_Q2_es/F");
   T->Branch("event_x_es", &fTreeVar.event_x_es, "event_x_es/F");

   T->Branch("event_y_da", &fTreeVar.event_y_da, "event_y_da/F");
   T->Branch("event_Q2_da", &fTreeVar.event_Q2_da, "event_Q2_da/F");

   T->Branch("event_y_h", &fTreeVar.event_y_h, "event_y_h/F");
   T->Branch("event_Q2_h", &fTreeVar.event_Q2_h, "event_Q2_h/F");
   ...
   T->Branch("gen_event_Q2_es", &fTreeVar.gen_event_Q2_es, "gen_event_Q2_es/F");
   T->Branch("gen_event_y_es",&fTreeVar.gen_event_y_es, "gen_event_y_es/F");
   T->Branch("gen_event_x_es", &fTreeVar.gen_event_x_es, "gen_event_x_es/F"); 
 
   T->Branch("gen_event_Q2_s",&fTreeVar.gen_event_Q2_s, "gen_event_Q2_s/F");
   T->Branch("gen_event_y_s",&fTreeVar.gen_event_y_s, "gen_event_y_s/F");
   T->Branch("gen_event_x_s", &fTreeVar.gen_event_x_s, "gen_event_x_s/F");

   T->Branch("gen_event_Q2_e",&fTreeVar.gen_event_Q2_e, "gen_event_Q2_e/F");
   T->Branch("gen_event_y_e",&fTreeVar.gen_event_y_e, "gen_event_y_e/F");
   T->Branch("gen_event_x_e", &fTreeVar.gen_event_x_e,"gen_event_x_e/F");
